...
class BufferPruningWorkerTest {
    ...
    @Test
    fun testBufferPruningWorkerConstructionAndExecution() = runBlocking {
        val worker = BufferPruningWorker(context, workerParams, repository)
